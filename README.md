...
* **Autenticación Fluida:** Pantalla única de Login y Registro controlada por transformaciones de estado y animaciones, incluyendo retroalimentación visual (Shake Animation) para errores de validación.
...
* **Integración API REST:** Consumo de una API pública simulando un entorno de producción para operaciones CRUD (Create, Read, Update, Delete) operando en conjunto con la base de datos local.
